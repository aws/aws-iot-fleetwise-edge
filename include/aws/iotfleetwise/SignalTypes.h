...
/**
 * @brief Indicates the type of the value in the raw payload received by FWE.
 *
 * If FLOATING_POINT, the raw value will be cast to a IEEE Float or Double, depending on the signal size.
 */
enum struct RawSignalType
{
    INTEGER = 0,
    FLOATING_POINT = 1,
};
...
struct CANSignalFormat
{
    ...
    /**
     * @brief The datatype of the signal after applying any scaling and offset.
     */
