...
enum class TraceVariable
{
    ...
    MQTT_HEAP_USAGE,
    SIGNAL_BUFFER_SIZE,
    LAST_KNOWN_STATE_SIGNAL_HISTORY_BUFFER_SIZE,
    RAW_DATA_OVERWRITTEN_DATA_WITH_USED_HANDLE,
    RAW_DATA_BUFFER_ELEMENTS_PER_TYPE,
    RAW_DATA_BUFFER_MANAGER_BYTES,
    MQTT_COMMAND_RESPONSE_MESSAGE_SENT_OUT,
    COMMAND_REQUESTS_RECEIVED,
    COMMAND_EXECUTION_FAILURE,
    COMMAND_PRECONDITION_CHECK_FAILURE,
    COMMAND_EXECUTION_TIMEOUT,
    COMMAND_DECODER_MANIFEST_FAILURE,
    COMMAND_REQUEST_PARSING_FAILURE,
    COMMAND_EXECUTION_TIMEOUT_BEFORE_DISPATCH,
    COMMAND_SETTING_SIGNAL_VALUE_FAILURE,
    STATE_TEMPLATES_RECEIVED,
    LAST_KNOWN_STATE_COLLECTION_TRIGGERS,
    MQTT_LAST_KNOWN_STATE_MESSAGE_SENT_OUT,
    MQTT_LAST_KNOWN_STATE_MESSAGE_FAILED_TO_BE_SENT,
    LAST_KNOWN_STATE_PERIODIC_UPDATES,
    LAST_KNOWN_STATE_ON_CHANGE_UPDATES,
    LAST_KNOWN_STATE_NO_SIGNAL_CHANGE_ON_PERIODIC_UPDATE,
    DATA_STORE_BYTES,
    DATA_STORE_SIGNAL_COUNT,
    QUEUED_S3_OBJECTS,
    DATA_FORWARD_BYTES,
    DATA_FORWARD_SIGNAL_COUNT,
    DATA_EXPIRED_BYTES,
    DATA_DROPPED_BYTES,
    DATA_STORE_ERROR,
    DATA_FORWARD_ERROR,
    VEHICLE_DATA_PUBLISH_COUNT,
    SHADOW_REQUESTS_SENT,
    SHADOW_GET_REQUESTS,
    SHADOW_DELETE_REQUESTS,
    SHADOW_UPDATE_REQUESTS,
    SHADOW_DOCUMENTS_UPDATES_RECEIVED,
    SHADOW_ACCEPTED_RESPONSES,
    SHADOW_REJECTED_RESPONSES,
    SHADOW_UNKNOWN_RESPONSES,
...
enum class TraceAtomicVariable
{
    ...
    QUEUE_PENDING_COMMAND_REQUESTS,
    QUEUE_PENDING_COMMAND_RESPONSES,
...
enum class TraceSection
{
    ...
    MANAGER_LAST_KNOWN_STATE_BUILD,
    MANAGER_EXTRACTION,
    CAN_DECODER_CYCLE_0,
    CAN_DECODER_CYCLE_1,
    CAN_DECODER_CYCLE_2,
