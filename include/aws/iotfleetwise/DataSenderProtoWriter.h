...
public:
     ...
     */
    DataSenderProtoWriter( CANInterfaceIDTranslator &canIDTranslator, RawData::BufferManager *rawDataBufferManager );
     ...
     *
     * @param triggeredCollectionSchemeData  collected data and metadata to be sent to cloud
     * @param collectionEventID       a unique ID to tie multiple signals to a single collection event
     */
    void setupVehicleData( const TriggeredCollectionSchemeData &triggeredCollectionSchemeData,
