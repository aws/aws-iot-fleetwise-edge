...
public:
     ...
     */
    DataSenderIonWriter( RawData::BufferManager *rawDataBufferManager, std::string vehicleId );
     ...
     */
    virtual void setupVehicleData( const TriggeredVisionSystemData &triggeredVisionSystemData );
