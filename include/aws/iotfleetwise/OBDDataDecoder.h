...
public:
    OBDDataDecoder( const OBDDecoderDictionary &decoderDictionary );
...
private:
    ...
    const OBDDecoderDictionary &mDecoderDictionary;
    ...
    static DecodedSignalValue decodeIntegerValue( const CANSignalFormat &formula,
                                                  const std::vector<uint8_t> &inputData,
                                                  size_t byteCounter );

    static DecodedSignalValue decodeFloatingPointValue( const CANSignalFormat &formula,
                                                        const std::vector<uint8_t> &inputData,
                                                        size_t byteCounter );
     ...
     */
    template <typename T>
    static auto extractRawSignal( const CANSignalFormat &formula,
                                  const std::vector<uint8_t> &inputData,
