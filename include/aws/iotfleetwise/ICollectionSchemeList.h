 ...
 * proto and return an array of ICollectionScheme.
 *
...
public:
     ...
     */
    virtual const std::vector<std::shared_ptr<ICollectionScheme>> &getCollectionSchemes() const = 0;
...
{
    std::vector<std::shared_ptr<ICollectionScheme>> activeCollectionSchemes;
};
