...
Improvements:
* Added Mac-user-friendly commands
* Added an extra attribute, so that users can search in the Fleetwise console
* Changed vehicle name from "fwdemo" to "fwdemo-${account}" for better readability and identification
