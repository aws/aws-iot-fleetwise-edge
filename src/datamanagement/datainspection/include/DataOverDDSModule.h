...
{
public:
    DataOverDDSModule() = default;
    ~DataOverDDSModule() override;

    DataOverDDSModule( const DataOverDDSModule & ) = delete;
    DataOverDDSModule &operator=( const DataOverDDSModule & ) = delete;
    DataOverDDSModule( DataOverDDSModule && ) = delete;
    DataOverDDSModule &operator=( DataOverDDSModule && ) = delete;
