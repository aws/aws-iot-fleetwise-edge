...
TEST( CollectionSchemeIgestionTest, Checkins )
{
    ...
    std::shared_ptr<const Clock> clock = ClockHandler::getClock();
    timestampT timeBeforeCheckin = clock->timeSinceEpochMs();
...
#define NODE_A 123
#define NODE_B 4892
#define CAN_CHANNEL_FOR_NODE_A 0
#define CAN_CHANNEL_FOR_NODE_B 1
    ...
    ASSERT_EQ( protoOBDPIDSignalA->service_mode(), obdPIDDecoderFormat.mServiceMode );
    ...
    ASSERT_EQ( protoOBDPIDSignalB->service_mode(), obdPIDDecoderFormat.mServiceMode );
    ...
    ASSERT_EQ( testPIDM.getNetworkProtocol( 3908 ), RAW_SOCKET );
    ASSERT_EQ( testPIDM.getNetworkProtocol( 2987 ), RAW_SOCKET );
    ASSERT_EQ( testPIDM.getNetworkProtocol( 50000 ), RAW_SOCKET );
    ASSERT_EQ( testPIDM.getNetworkProtocol( 123 ), OBD );
    ASSERT_EQ( testPIDM.getNetworkProtocol( 567 ), OBD );
}
