...
public:
    ...
    DataCollectionSenderTest()
    {
        ...
        {
            collectedDataPtr->mDTCInfo.mSID = STORED_DTC;
...
TEST_F( DataCollectionSenderTest, TestMaxMessageCountNotHit )
{
    ...
    DataCollectionSender dataCollectionSender( mockSender, true, 10, canIDTranslator );
...
TEST_F( DataCollectionSenderTest, TestMaxMessageCountHit )
{
    auto mockSender = std::make_shared<MockSender>();
    CANInterfaceIDTranslator canIDTranslator;
    DataCollectionSender dataCollectionSender( mockSender, true, 2, canIDTranslator );
