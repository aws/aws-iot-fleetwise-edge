...
public:
     ...
     */
    bool decodeDTCs( const SID &sid, const std::vector<uint8_t> &inputData, DTCInfo &info );
     ...
     */
    bool decodeVIN( const std::vector<uint8_t> &inputData, std::string &vin );

    bool extractDTCString( const uint8_t &firstByte, const uint8_t &secondByte, std::string &dtcString );
