...
typedef std::shared_ptr<SchemaListener> SchemaListenerPtr;
...
public:
    ...
    CollectionSchemeManager( const std::string dm_id );
...
private:
     ...
     */
    void printEventLogMsg( std::string &msg,
                           const std::string &id,
     ...
     */
    void printWakeupStatus( std::string &wakeupStr );
...
private:
    ...
    uint64_t mCheckinIntervalInMsec;
...
protected:
     ...
     */
    bool mCollectionSchemeAvailable;
    /*
     * parameters used in  onCollectionSchemeAvailable()
     ...
     */
    bool mDecoderManifestAvailable;
    /*
     * parameters used in  onDecoderManifestAvailable()
