...
{
    GeohashInfo()
        : mGeohashString( std::string() )
        , mPrevReportedGeohashString( std::string() )
...
public:
     ...
     * Note Geohash String will be initialized as maximum precision at south pole.
     */
    GeohashFunctionNode();
...
private:
     ...
     */
    double convertToDecimalDegree( double val, GeohashFunction::GPSUnitType gpsUnitType );
